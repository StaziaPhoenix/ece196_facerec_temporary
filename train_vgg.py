...
def load_model():
    ...
    base_out = Dense(units=256)(base_out)
    base_out = Dropout(rate=0.5)(base_out)
    predictions = Dense(units=NUM_CLASSES)(base_out) # ??
    ...
    model.compile(loss='categorial_crossentropy', optimizer=sgd)
